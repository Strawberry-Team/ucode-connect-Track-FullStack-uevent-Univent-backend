import { Controller, Get, Param, Post, Body, Patch, Delete, HttpStatus, NotImplementedException } from '@nestjs/common';
...
export class EventsController extends BaseCrudController<Event, CreateEventDto, UpdateEventDto> {
    ...
    protected async createEntity(dto: CreateEventDto, userId: number): Promise<Event> {
        return this.eventsService.createEvent(dto);
    }

    protected async updateEntity(id: number, dto: UpdateEventDto, userId: number): Promise<Event> {
    ...
    async create(@Body() dto: CreateEventDto, @UserId() userId: number): Promise<Event> {
