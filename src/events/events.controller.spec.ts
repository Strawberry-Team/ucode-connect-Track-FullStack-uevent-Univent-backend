...
import { generateFakeEvent, generateFakeCreateEventDto, generateFakeUpdateEventDto } from './utils/fake-event';
import { Reflector } from '@nestjs/core';

// Мокуємо JwtAuthGuard
jest.mock('../auth/guards/auth.jwt-guards', () => ({
...
describe('EventsController', () => {
        ...
        const module: TestingModule = await Test.createTestingModule({
            ...
            providers: [
                ...
                },
                {
                    provide: Reflector,
                    useValue: {
                        getAllAndOverride: jest.fn().mockReturnValue(true), // Для @Public() декоратора
                    },
                },
            ],
        }).compile();
    ...
    describe('Get Event By Id', () => {
        it('Should return an event by ID (public endpoint)', async () => {
            ...
            const result = await controller.getById(fakeEvent.id);
